    ...
    <div class="row register-card shadow-lg rounded overflow-hidden bg-white" id="register-card" style="width: 90%; max-width: 1250px;">
        ...
        <div class="col-md-11 d-flex flex-column justify-content-center position-relative form-container py-3">
            ...
            <div class="form-wrapper mx-auto">
                <form action="<?php echo e(route('faculty_register')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-2">
                            ...
                            <input type="text" id="faculty_id" name="faculty_id" value="<?php echo e(old('faculty_id')); ?>" class="form-control form-control-lg">
...
<?php echo $__env->make('layouts.simple_content_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LE_Project_Clg\resources\views/Login_Registers/Faculty_Register.blade.php ENDPATH**/ ?>