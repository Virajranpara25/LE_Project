            ...
            <div class="form-wrapper mx-auto">
                <form action="<?php echo e(route('register')); ?>" method="POST">
                    ...
                    <div class="text-center mt-3">
                        <a href="<?php echo e(route('login')); ?>" class="text-muted">Already have an account? Login</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('layouts.simple_content_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LE_Project\resources\views/Login_Registers/Register.blade.php ENDPATH**/ ?>